...
export default function SettingsMenu() {
    ...
    return (
        ...
        <div className={`fixed bottom-[20px] left-[15px] md:top-10 md:bottom-auto md:left-[50%] z-50 p-2 opacity-50 rounded-full ${darkMode? 'bg-containerDark':'bg-containerLight'}`}>
            <div
                onClick={toggleDarkMode}
